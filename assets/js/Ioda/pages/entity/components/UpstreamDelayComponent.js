...
const UpstreamDelayComponent = ( { from, until, rawAsnSignalsUpstreamDelayLatency, rawAsnSignalsUpstreamDelayPenultAsnCount, entityName } ) => {
                        ...
                        <div className="upstream__chart">
                                ...
                                <div className="card">
                                    ...
                                    <div className="content-area px-0">
                                        {activeTab === "1" ? (
                                            <HighchartsReact highcharts={Highcharts} options={latencyCombined} ref={chartCombinedRef}/>
                                        ) : (
                                            <HighchartsReact highcharts={Highcharts} options={latencyIndividual} ref={chartIndividualRef}/>
                                        )}
                                    </div>
                                </div>
                                <div className="px-4 card">
                                    <HighchartsReact highcharts={Highcharts} options={traceRouteOptions} ref={chartTraceRouteRef}/>
                                </div>
                            </div>}
                    {!jsonData &&
                        <Loading/>}

  ...
  genChart() {
    ...
    this.props.eventDataProcessed
      ? (chart
          ...
          ({ series, ts, val }) => `${series}<br>${ts}: ${humanizeNumber(val)}`)
      : null;
  }
                    ...
                    .tab__config-button:after {
                        ${
                          this.props.tabCurrentView === "timeSeries"
                            ? `content: "${viewTitleChart}"`
                            : `content: "${viewTitleMap}"`
                        };
                        font-size: 1rem;
                        font-style: italic;
                        position: absolute;
                ...
                <div className="col-2-of-3">
                  <div className="tab__config" ref={this.config}>
                    ...
                    <div className="tab__config-button-container">
                      <button
                        className="tab__config-button"
                        onClick={() => this.props.handleTabChangeViewButton()}
                        style={
                          this.props.type === "asn" ? { display: "none" } : null
                        }
                      >
                        <img
                          className="tab__config-button-img"
                          src={
                            this.props.tabCurrentView === "timeSeries"
                              ? iconGlobe
                              : iconChart

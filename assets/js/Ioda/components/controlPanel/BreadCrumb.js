...
const DynamicBreadCrumb = ({
      ...
      switch (entityType) {
        case "country":
          itemsList = itemsList.concat({
            title: (
              <a href="/dashboard" style={{ color: "#000" }}>
                {" "}
                All Countries{" "}
              </a>
            ),
          ...
          if (entityCode != null) {
            ...
            itemsList = itemsList.concat({
              title: (
                <a href={countryUrl} style={{ color: "#000" }}>
                  {" "}
                  {countryName}{" "}
                </a>
              ),
        ...
        case "region":
          ...
          itemsList = itemsList.concat({
            title: (
              <a href={regionUrl} style={{ color: "#000" }}>
                {" "}
                {regionName}{" "}
              </a>
            ),
        ...
        case "asn":
          itemsList = itemsList.concat({
            title: (
              <a href="/dashboard/asn" style={{ color: "#000" }}>
                {" "}
                All Networks{" "}
              </a>
            ),
  ...
  return (
    <div className="flex items-start p-6 ">
      {items && <Breadcrumb items={items} style={{ fontSize: "16px" }} />}
    </div>
  );
};
